	...
	$(document).ready(function() {
		...
		$('#submitBtn').click(function() {
			...
			if (f1.id.value == "") {
				...
				f1.addr2.focus();
				return false;
			} else if ($('#idck').val() == "false") {
				alert("아이디 중복체크를 해주십시오!!");
				$('#id').focus();
			} else {
				$.ajax({
					type : 'get',
					url : path + "/login_insert.do",
					data : query,
	...
	<form name="f1">
		<table border=1 align="center">
			<tr>
				...
				<input type="button" value="중복체크" id="checkBtn" /></td>
			</tr>
			<tr>
				<td>비밀번호</td>
			...
			<tr>
				<td>주소</td>
				<td align="left">
				<input type="number" name=zipcode id="sample6_postcode" placeholder="우편번호">
				...
				<input type="text" name=addr3 id="sample6_extraAddress" placeholder="참고항목"></td>
			</tr>
			<tr>
				<td colspan=2 align="center">
				<input type=button value="회원가입" id="submitBtn"></td>
			</tr>
		</table>
	</form>
</section>
